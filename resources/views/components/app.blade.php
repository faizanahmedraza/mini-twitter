<x-master>
    <section class="mx-auto min-h-screen">
        <main class="grid grid-cols-12 gap-0">
            ...
            <div class="col-span-12 lg:col-start-5 lg:col-end-9 lg:col-span-4">
                <div class="border-r border-l border-gray-100 mx-5 relative">
                    {{$slot}}
                </div>
            </div>
            <div class="col-span-12 lg:col-start-9 lg:col-end-11 lg:col-span-2 relative">
                @include('_friends_list')
            </div>
        </main>
    </section>
    <x-flash-message></x-flash-message>
    <x-tweet-comment-modal></x-tweet-comment-modal>
</x-master>